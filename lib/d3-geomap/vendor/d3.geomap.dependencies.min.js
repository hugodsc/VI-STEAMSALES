!function() {
    ...
    function u(n) {
        return {
            left: function(t, e, r, i) {
                ...
                arguments.length < 4 && (i = t.length); i > r; ) {
                    var u = r + i >>> 1;
                    n(t[u], e) < 0 ? r = u + 1 : i = u
                }
                return r
    ...
    function z(n, t) {
        ...
        return n = ao.ns.qualify(n),
        null == t ? n.local ? r : e : "function" == typeof t ? n.local ? a : o : n.local ? u : i
    }
    function L(n) {
    ...
    function D(n) {
        ...
        return function(e, r) {
            ...
            r ? (t.lastIndex = 0,
            t.test(i) || e.setAttribute("class", L(i + " " + n))) : e.setAttribute("class", L(i.replace(t, " ")))
        }
    }
    function P(n, t, e) {
        function r() {
    ...
    function W(e) {
        ...
        if (null == Ro && (Ro = "onselectstart"in e ? !1 : x(e.style, "userSelect")),
        Ro) {
            var o = n(e).style
              , a = o[Ro];
            o[Ro] = "none"
    ...
    function cn(n, t, e) {
        function r(n) {
            ...
            60 > n ? u + (o - u) * n / 60 : 180 > n ? o : 240 > n ? u + (o - u) * (240 - n) / 60 : u
        }
        function i(n) {
    ...
    function fn(n, t, e) {
        return this instanceof fn ? (this.h = +n,
        this.c = +t,
        void (this.l = +e)) : arguments.length < 2 ? n instanceof fn ? new fn(n.h,n.c,n.l) : n instanceof hn ? gn(n.l, n.a, n.b) : gn((n = Sn((n = ao.rgb(n)).r, n.g, n.b)).l, n.a, n.b) : new fn(n,t,e)
    }
    function sn(n, t, e) {
        return isNaN(n) && (n = 0),
        isNaN(t) && (t = 0),
    ...
    function hn(n, t, e) {
        ...
        this.a = +t,
        void (this.b = +e)) : arguments.length < 2 ? n instanceof hn ? new hn(n.l,n.a,n.b) : n instanceof fn ? sn(n.h, n.c, n.l) : Sn((n = mn(n)).r, n.g, n.b) : new hn(n,t,e)
    }
    function pn(n, t, e) {
        var r = (n + 16) / 116
          , i = r + t / 500
        ...
        r = vn(r) * ta,
        u = vn(u) * ea,
        new mn(yn(3.2404542 * i - 1.5371385 * r - .4985314 * u),yn(-.969266 * i + 1.8760108 * r + .041556 * u),yn(.0556434 * i - .2040259 * r + 1.0572252 * u))
    }
    function gn(n, t, e) {
    ...
    function mn(n, t, e) {
        return this instanceof mn ? (this.r = ~~n,
        this.g = ~~t,
        void (this.b = ~~e)) : arguments.length < 2 ? n instanceof mn ? new mn(n.r,n.g,n.b) : _n("" + n, mn, cn) : new mn(n,t,e)
    }
    function Mn(n) {
    ...
    function _n(n, t, e) {
        ...
        a = a >> 4 | a,
        l = 15 & u,
        l = l << 4 | l) : 7 === n.length && (o = (16711680 & u) >> 16,
        a = (65280 & u) >> 8,
        l = 255 & u)),
        t(o, a, l))
    }
    ...
    function qn(n, t, e) {
        ...
        return aa ? aa.n = u : oa = u,
        aa = u,
        la || (ca = clearTimeout(ca),
        la = 1,
        fa(Tn)),
        u
    }
    function Tn() {
        var n = Rn()
          , t = Dn() - n;
        t > 24 ? (isFinite(t) && (clearTimeout(ca),
        ca = setTimeout(Tn, t)),
        la = 0) : (la = 1,
        fa(Tn))
    }
    ...
    function jn(n) {
        ...
        return function(n) {
            ...
            return function(n) {
                ...
                return M && (x = u(k + x, k.length ? f - b.length : 1 / 0)),
                i += v,
                n = x + b,
    ...
    function On(n, t, e) {
        ...
        function i(e) {
            return t(e = n(new va(e - 1)), 1),
            e
        }
        function u(n, e) {
            return t(n = new va(+n), e),
            n
        }
        function o(n, r, u) {
            var o = i(n)
        ...
        function t(n) {
            function t(t) {
                for (var e, i, u, o = [], a = -1, l = 0; ++a < r; )
                    37 === n.charCodeAt(a) && (o.push(n.slice(l, a)),
                    null != (i = ya[e = n.charAt(++a)]) && (e = n.charAt(++a)),
                    (u = A[e]) && (e = u(t, null == i ? "e" === e ? " " : "0" : i)),
                    o.push(e),
                    l = a + 1);
                return o.push(n.slice(l, a)),
                o.join("")
            }
            var r = n.length;
        ...
        return function(i, u) {
            ...
            var p, g, v, d = t(u), y = i.invert(r[0], r[1]), m = {
                ...
                polygonEnd: function() {
                    ...
                    p = ao.merge(p);
                    var n = Ot(y, g);
                    p.length ? (b || (u.polygonStart(),
                    b = !0),
                    Lt(p, Ut, n, e, u)) : n && (b || (u.polygonStart(),
                    b = !0),
                    u.lineStart(),
                    e(null, null, 1, u),
                    u.lineEnd()),
    ...
    function jt(n) {
        ...
        return {
            ...
            point: function(u, o) {
                var a = u > 0 ? Fo : -Fo
                  , l = xo(u - e);
                xo(l - Fo) < Uo ? (n.point(e, r = (r + o) / 2 > 0 ? Io : -Io),
                n.point(i, r),
                n.lineEnd(),
                n.lineStart(),
                n.point(a, r),
                n.point(u, r),
                t = 0) : i !== a && l >= Fo && (xo(e - i) < Uo && (e -= i * Uo),
                xo(u - a) < Uo && (u -= a * Uo),
                r = Ft(e, r, u, o),
                n.point(i, r),
                n.lineEnd(),
            ...
            if (f)
                for (var s = c[0], h = s[0], p = s[1] / 2 + Fo / 4, g = Math.sin(p), v = Math.cos(p), d = 1; ; ) {
                    ...
                    var y = n[0]
                      ...
                      , S = w > Fo
                      , k = g * M;
                    if (ka.add(Math.atan2(k * _ * Math.sin(w), v * x + k * Math.cos(w))),
                    u += S ? b + _ * Ho : b,
                    S ^ h >= e ^ y >= e) {
                        var N = mt(dt(s), dt(n));
                        bt(N);
    ...
    function It(n) {
        ...
        function r(n, t, e) {
            ...
            if (!(0 > M)) {
                ...
                k = N,
                N = _),
                C ? A ? k + N > 0 ^ b[1] < (xo(b[0] - w) < Uo ? k : N) : k <= b[1] && b[1] <= N : E > Fo ^ (w <= b[0] && b[0] <= S)) {
                    var z = xt(d, (-y + x) / m);
                    return Mt(z, g),
                    [b, _t(z)]
                }
    ...
    function ee(n) {
        ...
        return t.precision = function(n) {
            return arguments.length ? (a = (u = n * n) > 0 && 16,
            t) : Math.sqrt(u)
        }
        ,
        t
    ...
    function ae(n) {
        function t(n) {
            return n = a(n[0] * Yo, n[1] * Yo),
            [n[0] * h + l, c - n[1] * h]
        }
        function e(n) {
            return n = a.invert((n[0] - l) / h, (c - n[1]) / h),
            n && [n[0] * Zo, n[1] * Zo]
        }
        function r() {
            a = Ct(o = se(y, M, x), u);
        ...
        t.translate = function(n) {
            return arguments.length ? (p = +n[0],
            g = +n[1],
            r()) : [p, g]
        }
        ,
        t.center = function(n) {
            return arguments.length ? (v = n[0] % 360 * Yo,
            d = n[1] % 360 * Yo,
            r()) : [v * Zo, d * Zo]
        }
        ,
        t.rotate = function(n) {
            return arguments.length ? (y = n[0] % 360 * Yo,
            M = n[1] % 360 * Yo,
        ...
        for (var t, e, r, i, u, o, a, l, c, f, s = n[0][0], h = n[1][0], p = n[0][1], g = n[1][1], v = ul, d = v.length; d--; )
            ...
            u && u.prepare())
                ...
                o = 0; l > o; )
                    ...
                    t = c.x,
                    e = c.y,
                    (xo(r - t) > Uo || xo(i - e) > Uo) && (a.splice(o, 0, new tr(Qe(u.site, f, xo(r - s) < Uo && g - i > Uo ? {
                        x: s,
                        y: xo(t - s) < Uo ? e : g
                    } : xo(i - g) < Uo && h - r > Uo ? {
                        x: xo(e - g) < Uo ? t : h,
    ...
    function ar(n, t) {
        ...
        for (il = [],
        ul = new Array(n.length),
        ol = new er,
        ll = new er; ; )
            if (i = al,
            u && (!i || u.y < i.y || u.y === i.y && u.x < i.x))
                u.x === e && u.y === r || (ul[u.i] = new Ye(u),
                He(u),
                e = u.x,
                r = u.y),
                u = n.pop();
    ...
    function mr(n, t) {
        ...
        for (n += "",
        t += ""; (e = hl.exec(n)) && (r = pl.exec(t)); )
            (i = r.index) > u && (i = t.slice(u, i),
            a[o] ? a[o] += i : a[++o] = i),
    ...
    function Lr(n, t) {
        ...
        arguments.length ? e = t / Ho * Math.asin(1 / n) : (n = 1,
        e = t / 4),
        function(r) {
    ...
    function Rr(n, t) {
        ...
        r = isNaN(r) ? t.c : r),
        isNaN(u) ? (u = 0,
        e = isNaN(e) ? t.h : e) : u > 180 ? u -= 360 : -180 > u && (u += 360),
        function(n) {
    ...
    function jr(n) {
        ...
        r *= -1,
        i *= -1),
        this.rotate = (r ? Math.atan2(t[1], t[0]) : Math.atan2(-e[0], e[1])) * Zo,
    ...
    function ii(n, t) {
        return ao.rebind(n, t, "sort", "children", "value"),
        n.nodes = n,
        n.links = fi,
        n
    }
            ...
            c > 2))
                ...
                o = 3; c > o; o++) {
                    ...
                    var g = 0
                      , v = 1
                      , d = 1;
                    for (a = i._pack_next; a !== i; a = a._pack_next,
                    v++)
                        if (ki(a, u)) {
                            g = 1;
                            break
                    ...
                    if (1 == g)
                        for (l = r._pack_prev; l !== a._pack_prev && !ki(l, u); l = l._pack_prev,
                        d++)
                            ;
                    g ? (d > v || v == d && i.r < r.r ? Si(r, i = a) : Si(r = l, i),
                    o--) : (wi(r, u),
                    i = u,
                    t(u))
                }
    ...
    function iu(n, t, e) {
        ...
        ,
        r.domain = function(t) {
            return arguments.length ? (n.domain((e = t.map(Number)).map(i)),
            r) : e
        }
        ,
        r.ticks = function(n) {
        ...
        r.exponent = function(o) {
            return arguments.length ? (i = uu(t = o),
            u = uu(1 / t),
            n.domain(e.map(i)),
            r) : t
        }
    ...
    function ou(n, t) {
        ...
        e.rangePoints = function(i, a) {
            ...
            var l = i[0]
              , c = i[1]
              , f = n.length < 2 ? (l = (l + c) / 2,
            0) : (c - l) / (n.length - 1 + a);
            return u = r(l + f * a / 2, f),
            o = 0,
            t = {
                t: "rangePoints",
                a: arguments
        ...
        e.rangeRoundPoints = function(i, a) {
            ...
            var l = i[0]
              , c = i[1]
              , f = n.length < 2 ? (l = c = Math.round((l + c) / 2),
            0) : (c - l) / (n.length - 1 + a) | 0;
        ...
        e.rangeRoundBands = function(i, a, l) {
            ...
            return u = r(f + Math.round((s - f - (n.length - a) * h) / 2), h),
            c && u.reverse(),
            o = Math.round(h * (1 - a)),
            t = {
                t: "rangeRoundBands",
    ...
    function au(n, t) {
        ...
        return o.domain = function(t) {
            return arguments.length ? (n = t.map(r).filter(i).sort(e),
            u()) : n
        }
        ,
        o.range = function(n) {
        ...
        o.invertExtent = function(e) {
            ...
            0 > e ? [NaN, NaN] : [e > 0 ? a[e - 1] : n[0], e < a.length ? a[e] : n[n.length - 1]]
        }
        ,
        o.copy = function() {
            return au(n, t)
    ...
    function Mu(n) {
        function t(t) {
            ...
            for (var l, c = [], f = [], s = -1, h = t.length, p = En(e), g = En(r); ++s < h; )
                i.call(this, l = t[s], s) ? f.push([+p.call(this, l, s), +g.call(this, l, s)]) : f.length && (o(),
                f = []);
            return f.length && o(),
    ...
    function Nu(n, t) {
        return n.length < 3 ? bu(n) : n[0] + Au((n.push(n[0]),
        n), Cu([n[n.length - 2]].concat(n, [n[1]]), t))
    }
    function Eu(n, t) {
    ...
    function ju(n) {
        for (var t, e, r, i, u = [], o = Uu(n), a = -1, l = n.length - 1; ++a < l; )
            t = Pu(n[a], n[a + 1]),
            xo(t) < Uo ? o[a] = o[a + 1] = 0 : (e = o[a] / t,
            r = o[a + 1] / t,
            i = e * e + r * r,
            i > 9 && (i = 3 * t / Math.sqrt(i),
            o[a] = i * e,
            o[a + 1] = i * r));
        for (a = -1; ++a <= l; )
            i = (n[Math.min(l, a + 1)][0] - n[Math.max(0, a - 1)][0]) / (6 * (1 + o[a] * o[a])),
            u.push([i || 0, o[a] * i || 0]);
        return u
    }
    function Fu(n) {
    ...
    function Ou(n) {
        function t(t) {
            ...
            : En(u); ++m < M; )
                o.call(this, h = t[m], m) ? (d.push([p = +x.call(this, h, m), g = +b.call(this, h, m)]),
                y.push([+_.call(this, h, m), +w.call(this, h, m)])) : d.length && (l(),
                d = [],
                y = []);
            return d.length && l(),
    ...
    function Qu(n, t, e, r, i) {
        ...
        function a(i) {
            for (var u = i / s, o = h(u), a = p.length; a > 0; )
                p[--a].call(n, o);
            return u >= 1 ? (v.event && v.event.end.call(n, n.__data__, t),
    ...
    ao.shuffle = function(n, t, e) {
        (u = arguments.length) < 3 && (e = n.length,
        2 > u && (t = 0));
        for (var r, i, u = e - t; u; )
            i = Math.random() * u-- | 0,
            r = n[u + t],
    ...
    ao.nest = function() {
        function n(t, o, a) {
            if (a >= u.length)
                return r ? r.call(i, o) : e ? o.sort(e) : o;
    ...
    Co.select = function(n) {
        ...
        for (var o = -1, a = this.length; ++o < a; ) {
            ...
            for (var l = -1, c = r.length; ++l < c; )
                (i = r[l]) ? (t.push(e = n.call(i, i.__data__, l, o)),
    ...
    Co.selectAll = function(n) {
        ...
        for (var i = -1, u = this.length; ++i < u; )
            for (var o = this[i], a = -1, l = o.length; ++a < l; )
                (e = o[a]) && (r.push(t = co(n.call(e, e.__data__, a, i))),
                t.parentNode = e);
        return E(r)
    }
    ;
    ...
    Co.data = function(n, t) {
        function e(n, e) {
            ...
            if (t) {
                ...
                for (r = -1; ++r < o; )
                    (i = n[r]) && (y.has(d = t.call(i, i.__data__, r)) ? v[r] = i : y.set(d, i),
                    m[r] = d);
                for (r = -1; ++r < s; )
                    (i = y.get(d = t.call(e, u = e[r], r))) ? i !== !0 && (p[r] = i,
                    i.__data__ = u) : g[r] = H(u),
                    y.set(d, !0);
                for (r = -1; ++r < o; )
    ...
    Co.order = function() {
        for (var n = -1, t = this.length; ++n < t; )
            for (var e, r = this[n], i = r.length - 1, u = r[i]; --i >= 0; )
                (e = r[i]) && (u && u !== e.nextSibling && u.parentNode.insertBefore(e, u),
                u = e);
        return this
    }
    ,
    ...
    qo.select = function(n) {
        for (var t, e, r, i, u, o = [], a = -1, l = this.length; ++a < l; ) {
            ...
            for (var c = -1, f = i.length; ++c < f; )
                (u = i[c]) ? (t.push(r[c] = e = n.call(i.parentNode, u.__data__, c, a)),
    ...
    ao.select = function(t) {
        var e;
        return "string" == typeof t ? (e = [No(t, fo)],
        e.parentNode = fo.documentElement) : (e = [t],
        e.parentNode = n(t)),
        E([e])
    }
    ,
    ao.selectAll = function(n) {
        var t;
        return "string" == typeof n ? (t = co(Eo(n, fo)),
        t.parentNode = fo.documentElement) : (t = co(n),
        t.parentNode = null),
        E([t])
    }
    ,
    ...
    ao.behavior.drag = function() {
        ...
        function e(n, t, e, u, o) {
            return function() {
                ...
                function l() {
                    t(h, v) && (y.on(u + d, null).on(o + d, null),
                    m(g),
                    p({
                        type: "dragend"
                    }))
    ...
    ao.behavior.zoom = function() {
        ...
        function h() {
            ...
            function t() {
                ...
                if (1 === l.length) {
                    if (500 > c - M) {
                        var f = l[0];
                        o(g, f, d[f.identifier], Math.floor(Math.log(k.k) / Math.LN2) + 1),
                        S()
                    }
                    M = c
                } else if (l.length > 1) {
        ...
        function p() {
            ...
            m ? clearTimeout(m) : (Il.call(this),
            v = e(d = y || ao.mouse(this)),
            l(n)),
        ...
        n.scaleExtent = function(t) {
            return arguments.length ? (A = null == t ? Jo : [+t[0], +t[1]],
            n) : A
        }
        ,
        n.center = function(t) {
            return arguments.length ? (y = t && [+t[0], +t[1]],
            n) : y
        }
        ,
        n.size = function(t) {
        ...
        e.parseRows = function(n, t) {
            function e() {
                ...
                if (34 === n.charCodeAt(t)) {
                    ...
                    return 13 === r ? (i = !0,
                    10 === n.charCodeAt(e + 2) && ++f) : 10 === r && (i = !0),
        ...
        return function(n) {
            ...
            if (t) {
                ...
                for (var e, r = 1, i = M[0], u = [i]; t > r; ++r)
                    e = M[r],
                    c(e[0], i) || c(e[1], i) ? (a(i[0], e[1]) > a(i[0], i[1]) && (i[1] = e[1]),
                    a(e[0], i[1]) > a(i[0], i[1]) && (i[0] = e[0])) : u.push(i = e);
                for (var o, e, g = -(1 / 0), t = u.length - 1, r = 0, i = u[t]; t >= r; i = e,
                ++r)
                    e = u[r],
                    (o = a(i[1], e[0])) > g && (g = o,
                    f = e[0],
            ...
            return M = x = null,
            f === 1 / 0 || s === 1 / 0 ? [[NaN, NaN], [NaN, NaN]] : [[f, s], [h, p]]
        }
    }(),
    ...
    ao.geo.albersUsa = function() {
        ...
        n.scale = function(t) {
            ...
            o.scale(.35 * t),
            a.scale(t),
            n.translate(u.translate())) : u.scale()
        }
        ,
        n.translate = function(t) {
            if (!arguments.length)
    ...
    var Oa, Ia, Ya, Za, Va, Xa, $a = {
        ...
        polygonEnd: function() {
            $a.lineStart = $a.lineEnd = $a.point = b,
            Oa += xo(Ia / 2)
        }
    }, Ba = {
        point: Bt,
    ...
    ao.geo.path = function() {
        ...
        n.centroid = function(n) {
            return Ca = za = La = qa = Ta = Ra = Da = Pa = Ua = 0,
            ao.geo.stream(n, i(Wa)),
            Ua ? [Da / Ua, Pa / Ua] : Ra ? [qa / Ra, Ta / Ra] : La ? [Ca / La, za / La] : [NaN, NaN]
        }
        ,
        n.bounds = function(n) {
            return Va = Xa = -(Ya = Za = 1 / 0),
            ao.geo.stream(n, i(Ba)),
            [[Ya, Za], [Va, Xa]]
        }
        ,
        n.projection = function(n) {
            return arguments.length ? (i = (e = n) ? n.stream || re(n) : m,
            t()) : e
        }
        ,
        n.context = function(n) {
            return arguments.length ? (u = null == (r = n) ? new Wt : new te(n),
    ...
    ao.geo.rotation = function(n) {
        function t(t) {
            return t = n(t[0] * Yo, t[1] * Yo),
            t[0] *= Zo,
            t[1] *= Zo,
            t
        }
        return n = se(n[0] % 360 * Yo, n[1] * Yo, n.length > 2 ? n[2] * Yo : 0),
        t.invert = function(t) {
            return t = n.invert(t[0] * Yo, t[1] * Yo),
            t[0] *= Zo,
            t[1] *= Zo,
            t
        }
    ...
    ao.geo.circle = function() {
        ...
        ,
        n.angle = function(r) {
            return arguments.length ? (e = ve((t = +r) * Yo, i * Yo),
            n) : t
        }
        ,
        n.precision = function(r) {
            return arguments.length ? (e = ve(t * Yo, (i = +r) * Yo),
            n) : i
        }
        ,
        n.angle(90)
    ...
    ao.geo.graticule = function() {
        ...
        n.majorExtent = function(t) {
            return arguments.length ? (u = +t[0][0],
            i = +t[1][0],
            c = +t[0][1],
            l = +t[1][1],
            u > i && (t = u,
    ...
    rl.clip = function(n) {
        for (var t, e, r, i, u, o, a = De(n), l = -1, c = this.length - De(this), f = this[c - 1]; ++l < c; ) {
            ...
            e = -1; ++e < r; )
                o = t[e],
                Te(o, f, i) ? (Te(u, f, i) || n.push(Re(u, o, f, i)),
                n.push(o)) : Te(u, f, i) && n.push(Re(u, o, f, i)),
                u = o;
            a && n.push(n[0]),
            f = i
        }
        ...
        t.triangles = function(n) {
            ...
            return ar(e(n)).cells.forEach(function(e, r) {
                for (var i, u, o = e.site, a = e.edges.sort(Ve), l = -1, c = a.length, f = a[c - 1].edge, s = f.l === o ? f.r : f.l; ++l < c; )
                    ...
                    f = a[l].edge,
                    s = f.l === o ? f.r : f.l,
                    r < u.i && r < s.i && cr(o, u, s) < 0 && t.push([n[r], n[u.i], n[s.i]])
            }),
            t
        }
        ,
        t.x = function(n) {
            return arguments.length ? (u = En(r = n),
            t) : r
        }
        ,
        t.y = function(n) {
            return arguments.length ? (o = En(i = n),
            t) : i
        }
        ,
        t.clipExtent = function(n) {
            return arguments.length ? (a = null == n ? sl : n,
            t) : a === sl ? null : a
        }
        ,
        t.size = function(n) {
    ...
    ao.geom.quadtree = function(n, t, e, r, i) {
        ...
        var o, a = Ce, l = ze;
        return (o = arguments.length) ? (a = fr,
        l = sr,
        3 === o && (i = e,
        r = t,
        e = t = 0),
        ...
        ,
        u.extent = function(n) {
            return arguments.length ? (null == n ? t = e = r = i = null : (t = +n[0][0],
            e = +n[0][1],
            r = +n[1][0],
            i = +n[1][1]),
            u) : null == t ? null : [[t, e], [r, i]]
        }
        ,
        u.size = function(n) {
    ...
    ao.layout.chord = function() {
        ...
        return c.matrix = function(n) {
            return arguments.length ? (u = (i = n) && i.length,
            e = r = null,
            c) : i
        }
        ,
    ...
    ao.layout.force = function() {
        ...
        return l.tick = function() {
            ...
            for (r = 0; w > r; ++r)
                ...
                m = p.x - h.x,
                b = p.y - h.y,
                (v = m * m + b * b) && (v = i * o[r] * ((v = Math.sqrt(v)) - u[r]) / v,
                m *= v,
                b *= v,
                p.x -= m * (y = h.weight + p.weight ? h.weight / (h.weight + p.weight) : .5),
                p.y -= b * y,
                h.x += m * (y = 1 - y),
                h.y += b * y);
            if ((y = i * d) && (m = f[0] / 2,
            ...
            y))
                for (; ++r < _; )
                    ...
                    l.y += (b - l.y) * y;
            if (g)
                for (ri(t = ao.geom.quadtree(M), i, a),
                r = -1; ++r < _; )
                    (l = M[r]).fixed || t.visit(n(l));
            for (r = -1; ++r < _; )
                l = M[r],
                l.fixed ? (l.x = l.px,
                l.y = l.py) : (l.x -= (l.px - (l.px = l.x)) * s,
                l.y -= (l.py - (l.py = l.y)) * s);
            c.tick({
                type: "tick",
                alpha: i
    ...
    ao.layout.stack = function() {
        function n(a, l) {
            ...
            for (g = 0; y > g; ++g)
                for (i.call(n, c[0][g], v = d[g], f[0][g][1]),
                p = 1; h > p; ++p)
        ...
        ,
        n.order = function(t) {
            return arguments.length ? (e = "function" == typeof t ? t : _l.get(t) || gi,
            n) : e
        }
        ,
        n.offset = function(t) {
            return arguments.length ? (r = "function" == typeof t ? t : wl.get(t) || vi,
            n) : r
        }
        ,
        n.x = function(t) {
    ...
    ao.layout.histogram = function() {
        function n(n, u) {
            ...
            if (p > 0)
                for (u = -1; ++u < h; )
                    a = c[u],
                    a >= f[0] && a <= f[1] && (o = l[ao.bisect(s, a, 1, p) - 1],
                    o.y += g,
                    o.push(n[u]));
            return l
        }
    ...
    ao.layout.tree = function() {
        ...
        ,
        n.size = function(t) {
            return arguments.length ? (c = null == (l = t) ? u : null,
            n) : c ? null : l
        }
        ,
        n.nodeSize = function(t) {
            return arguments.length ? (c = null == (l = t) ? null : u,
            n) : c ? l : null
        }
        ,
        ii(n, o)
    ...
    ao.layout.cluster = function() {
        ...
        ,
        n.size = function(t) {
            return arguments.length ? (i = null == (r = t),
            n) : i ? null : r
        }
        ,
        n.nodeSize = function(t) {
    ...
    ao.layout.treemap = function() {
        ...
        function t(e) {
            ...
            if (u && u.length) {
                ...
                f.area = 0; (l = h.length) > 0; )
                    f.push(o = h[l - 1]),
                    f.area += o.area,
                    "squarify" !== p || (a = r(f, v)) <= g ? (h.pop(),
                    g = a) : (f.area -= f.pop().area,
                    i(f, v, c, !1),
        ...
        function e(t) {
            ...
            if (r && r.length) {
                ...
                l.area = 0; u = a.pop(); )
                    l.push(u),
                    l.area += u.area,
                    null != u.z && (i(l, u.z ? o.dx : o.dy, o, !a.length),
                    l.length = l.area = 0);
                r.forEach(e)
            }
        }
    ...
    ao.svg.arc = function() {
        function n() {
            ...
            if (h > Uo && (g = Math.min(Math.abs(c - n) / 2, +i.apply(this, arguments))) > .001) {
                ...
                A.push("M", m, ",", M),
                null != x && A.push("A", c, ",", c, " 0 ", C, ",", p, " ", x, ",", b),
                A.push("L", _, ",", w),
                null != S && A.push("A", n, ",", n, " 0 ", L, ",", 1 - p, " ", S, ",", k);
            return A.push("Z"),
            A.join("")
        }
        function t(n, t) {
        ...
        n.padRadius = function(t) {
            return arguments.length ? (u = t == ql ? ql : En(t),
            n) : u
        }
        ,
        n.startAngle = function(t) {
    ...
    Yl.select = function(n) {
        ...
        for (var a = -1, l = this.length; ++a < l; ) {
            o.push(t = []);
            for (var c = this[a], f = -1, s = c.length; ++f < s; )
                (r = c[f]) && (e = n.call(r, r.__data__, f, a)) ? ("__data__"in r && (e.__data__ = r.__data__),
                Qu(e, f, u, i, r[u][i]),
    ...
    ao.svg.axis = function() {
        ...
        ,
        n.ticks = function() {
            return arguments.length ? (a = co(arguments),
            n) : a
        }
        ,
    ...
    ao.svg.brush = function() {
        ...
        function u() {
            ...
            function v() {
                32 == ao.event.keyCode && 2 == C && (L[0] += s[1],
                L[1] += h[1],
                C = 0,
                S())
            }
            function d() {
                ...
                x && (n[0] += x[0],
                n[1] += x[1]),
                C || (ao.event.altKey ? (M || (M = [(s[0] + s[1]) / 2, (h[0] + h[1]) / 2]),
                L[0] = s[+(n[0] < M[0])],
            ...
            function y(n, t, e) {
                ...
                C ? i = (r += f) + d : (M && (f = Math.max(l, Math.min(c, 2 * M[e] - r))),
                r > f ? (i = r,
                r = f) : i = f),
                v[0] != r || v[1] != i ? (e ? a = null : o = null,
                v[0] = r,
                v[1] = i,
                !0) : void 0
            }
        ...
        return n.event = function(n) {
            n.each(function() {
                var n = l.of(this, arguments)
                  ...
                  , e = this.__chart__ || t;
                this.__chart__ = t,
                Hl ? ao.select(this).transition().each("start.brush", function() {
                    o = e.i,
                    a = e.j,
                    s = e.x,
                    h = e.y,
        ...
        ,
        n.clamp = function(t) {
            return arguments.length ? (c && f ? (p = !!t[0],
            g = !!t[1]) : c ? p = !!t : f && (g = !!t),
    ...
    "function" == typeof define && define.amd ? (this.d3 = ao,
    define(ao)) : "object" == typeof module && module.exports ? module.exports = ao : this.d3 = ao
}();
!function() {
    function t(t, a) {
        return {
    ...
    function n(t, a) {
        ...
        if (!ga.hasOwnProperty(t.type))
            return null;
        var r = ga[t.type];
        return d3.geo.stream(t, a(r)),
        r.result()
    }
    function a() {}
    function r(t) {
        if ((n = t.length) < 4)
            return !1;
        for (var n, a = 0, r = t[n - 1][1] * t[0][0] - t[n - 1][0] * t[0][1]; ++a < n; )
    ...
    function s(t) {
        ...
        return n.invert = function(n, a) {
            ...
            } while (Math.abs(e) > da && --u > 0);var l = Math.sin(i);
    ...
    function c() {
        ...
        return a.radius = function(a) {
            return arguments.length ? n(t = a * pa / 180) : 180 * (t / pa)
        }
        ,
        a
    }
    ...
    function v(t) {
        ...
        return n.invert = function(t, n) {
            ...
            do {
                ...
                h -= y,
                u -= S
            } while ((Math.abs(y) > da || Math.abs(S) > da) && --M > 0);return e * u > -Math.atan2(Math.cos(h), o) - .001 ? [2 * h, u] : null
        }
        ,
        n
    }
    function l() {
        ...
        return e.parallel = function(e) {
            return arguments.length ? (a = Math.tan((n = (t = e * pa / 180) > 0 ? 1 : -1) * t),
            r(t)) : 180 * (t / pa)
        }
        ,
        e.stream = function(r) {
            ...
            h.sphere = function() {
                ...
                for (var r = -180 * n; 180 > n * r; r += 90 * n)
                    u.point(r, 90 * n);
                for (; n * (r -= t) >= -180; )
                    u.point(r, n * -Math.atan2(Math.cos(r * ma / 2), a) * ya);
                u.lineEnd(),
                u.polygonEnd()
            }
            ,
    ...
    function m(t, n) {
        var a = Math.abs(n);
        return pa / 4 > a ? [t, Math.log(Math.tan(pa / 4 + n / 2))] : [t * Math.cos(a) * (2 * Math.SQRT2 - 1 / Math.sin(a)), i(n) * (2 * Math.SQRT2 * (a - pa / 4) - Math.log(Math.tan(a / 2)))]
    }
    function y(t) {
        function n(t, n) {
            var r = Ta(t, n);
        ...
        return n.invert = function(t, n) {
            ...
            if (r > wa) {
                ...
                e = o + 2 * Math.atan((u + i * Math.sqrt(u * u - 3)) / 3),
                t = r * Math.cos(e),
                n = r * Math.sin(e)
            }
    ...
    function S() {
        ...
        a.stream = function(n) {
            ...
            M.sphere = function() {
                s.polygonStart(),
                s.lineStart();
                for (var n = 0, a = 360 / t, r = 2 * pa / t, u = 90 - 180 / t, M = wa; t > n; ++n,
                u -= a,
                M -= r)
                    s.point(Math.atan2(i * Math.cos(M), o) * ya, h(i * Math.sin(M)) * ya),
                    -90 > u ? (s.point(-90, -180 - u - e),
                    s.point(-90, -180 - u + e)) : (s.point(90, u + e),
                    s.point(90, u - e));
                s.lineEnd(),
                s.polygonEnd()
            }
    ...
    function Q(t) {
        return function(n) {
            ...
            while (Math.abs(a) > da && --e > 0);return n / 2
        }
    }
    function R(t, n, a) {
        function r(a, r) {
    ...
    function x(t) {
        ...
        return r.parallel = function(t) {
            return arguments.length ? a(n = t * pa / 180) : 180 * (n / pa)
        }
        ,
        r
    }
    ...
    function _(t) {
        function n(n, a) {
            for (var r = Math.sin(a), e = Math.cos(a), o = new Array(3), M = 0; 3 > M; ++M) {
                var s = t[M];
                if (o[M] = B(a - s[1], s[3], s[2], e, r, n - s[0]),
                !o[M][0])
                    return s.point;
                o[M][1] = j(o[M][1] - s.v[1])
            }
            for (var c = u.slice(), M = 0; 3 > M; ++M) {
                ...
                c[1] -= o[M][0] * Math.sin(v)) : (v = h - v,
                c[0] += o[M][0] * Math.cos(v),
                c[1] += o[M][0] * Math.sin(v)) : (c[0] += o[M][0] * Math.cos(v),
        ...
        var o = F(t[0].v[0], t[2].v[0], t[1].v[0])
          ...
          , h = pa - o;
        t[2].point[1] = 0,
        t[0].point[0] = -(t[1].point[0] = .5 * t[0].v[0]);
    ...
    function z() {
        ...
        a.points = function(e) {
            ...
            var o = d3.geo.centroid({
              ...
              , i = [-o[0], -o[1]];
            return r.call(a, i),
            n(t.map(d3.geo.rotation(i)).map(A))
        }
        ,
    ...
    function D(t, n) {
        var a = Math.sqrt(3);
        return [a * t * (2 * Math.cos(2 * n / 3) - 1) / qa, a * qa * Math.sin(n / 3)]
    }
    function L(t) {
        function n(t, n) {
    ...
    function I(t, n) {
        ...
        return [2 / Math.sqrt(6 * pa) * t * a, i(n) * Math.sqrt(2 * pa / 3) * (2 - a)]
    }
    function J(t, n) {
        var a = Math.sqrt(pa * (4 + pa));
        return [2 / a * t * (1 + Math.sqrt(1 - 4 * n * n / (pa * pa))), 4 / a * n]
    }
    function K(t, n) {
    ...
    function N(t, n) {
        return [t * (1 + Math.cos(n)) / Math.sqrt(2 + pa), 2 * n / Math.sqrt(2 + pa)]
    }
    function U(t, n) {
        for (var a = (1 + wa) * Math.sin(n), r = 0, e = 1 / 0; 10 > r && Math.abs(e) > da; r++)
            n -= e = (n + Math.sin(n) - a) / (1 + Math.cos(n));
        return a = Math.sqrt(2 + pa),
        [t * (1 + Math.cos(n)) / a, 2 * n / a]
    }
    function V(t, n) {
        var a = Math.sin(t /= 2)
          , r = Math.cos(t)
    ...
    function Y(t, n) {
        function a(n, a) {
            ...
            if (u > e) {
                ...
                var b, p = 50;
                do
                    i -= b = (t + tn(g, v, i) * d - M) / (g(i) * d);
                while (Math.abs(b) > da && --p > 0);h = f * Math.sin(i),
                wa > i && (h -= l * (i - wa));
                var w = Math.sin(c)
                  , q = Math.cos(c);
                o[0] = i * q - h * w,
    ...
    function $() {
        ...
        return o.radius = function(o) {
            return arguments.length ? (a = Math.cos(n = o * ma),
            r = Math.sin(n),
            e(n, t)) : n * ya
        }
        ,
        ...
        o.stream = function(n) {
            ...
            h.sphere = function() {
                s.polygonStart(),
                s.lineStart();
                for (var n = 0, e = 2 * pa / t, o = 0; t > n; ++n,
                o -= e)
                    s.point(Math.atan2(M * Math.cos(o), u) * ya, Math.asin(M * Math.sin(o)) * ya),
                    s.point(Math.atan2(r * Math.cos(o - e / 2), a) * ya, Math.asin(r * Math.sin(o - e / 2)) * ya);
                s.lineEnd(),
                s.polygonEnd()
            }
            ,
    ...
    function tn(t, n, a) {
        for (var r = 50, e = (a - n) / r, o = t(n) + t(a), i = 1, h = n; r > i; ++i)
            o += 2 * t(h += e);
        return .5 * o * e
    }
    function nn(t, n, a, r, e, o, i, h) {
        ...
        return arguments.length < 8 && (h = 0),
        u.invert = function(u, s) {
            var c, f, v = pa * u / t, l = s, g = 50;
            do {
                var d = l * l
                  , b = t + d * (n + d * (a + d * r))
                  , p = l * (e - 1 + d * (o - h + d * i))
                ...
                mcosα = m * cosα,
                msinα = m * sinα,
                dαdφ = v / pa * (1 / M(1 - xB2 / y)) * (dxBdφ * m - b * dmdφ) / y,
                fx = msinα - u,
            ...
            } while ((Math.abs(c) > da || Math.abs(f) > da) && --g > 0);return [v, l]
        }
        ,
        u
    }
        ...
        function a(n) {
            ...
            : function(n, a) {
                var e = n > 0 ? -.5 : .5
                  , o = t.invert(n + e * r, a)
                  , i = o[0] - e * pa;
                return -pa > i ? i += 2 * pa : i > pa && (i -= 2 * pa),
                o[0] = i,
                o
            }
            ),
    ...
    function Mn(t, n) {
        ...
        if (n >= 1 - da)
            ...
            e = 1 / r,
            i = r * d(t),
            [o + a * (i - t) / (r * r), e - a * o * e * (i - t), e + a * o * e * (i + t), 2 * Math.atan(Math.exp(t)) - wa + a * (i - t) / r];
        var u = [1, 0, 0, 0, 0, 0, 0, 0, 0]
          , s = [Math.sqrt(n), 0, 0, 0, 0, 0, 0, 0, 0]
          , c = 0;
        for (r = Math.sqrt(1 - n),
        i = 1; Math.abs(s[c] / u[c]) > da && 8 > c; )
            a = u[c++],
            s[c] = .5 * (a - r),
            u[c] = .5 * (a + r),
            r = M(a * r),
        ...
        e = i * u[c] * t;
        do
            o = s[c] * Math.sin(r = e) / u[c],
            e = .5 * (h(o) + e);
        while (--c);return [Math.sin(e), o = Math.cos(e), o / Math.cos(e - r), e]
    }
    function sn(t, n, a) {
        var r = Math.abs(t)
          , e = Math.abs(n)
    ...
    function cn(t, n) {
        if (!n)
            return t;
        if (1 === n)
            return Math.log(Math.tan(t / 2 + pa / 4));
    ...
    function bn() {
        ...
        ,
        a.rotate = function(n) {
            return arguments.length ? (r.call(a, [n[0], n[1] - 180 * (t / pa)]),
            o.origin([-n[0], -n[1]]),
            a) : (n = r.call(a),
            n[1] += 180 * (t / pa),
            n)
    ...
    function pn(t, n) {
        ...
        1 === n ? Ga : 1 / 0 === n ? qn : (a.invert = function(a, r) {
    ...
    function mn(t, n) {
        for (var a, r = Math.sin(n) * (0 > n ? 2.43763 : 2.67595), e = 0; 20 > e && (n -= a = (n + Math.sin(n) - r) / (1 + Math.cos(n)),
        !(Math.abs(a) < da)); e++)
            ;
    ...
    function Qn(t) {
        function n(n, e) {
            ...
            if (f && 2 > f) {
                ...
                } while (Math.abs(v) > ba && --g > 0);h = i * Math.sqrt(w),
                u = n * p / pa
            } else
                h = i * (t + f),
                u = n * o / pa;
        ...
        var a, r = 1 + t, e = Math.sin(1 / r), o = h(e), i = 2 * Math.sqrt(pa / (a = pa + 4 * o * r)), M = .5 * i * (r + Math.sqrt(t * (2 + t))), s = t * t, c = r * r;
        return n.invert = function(t, n) {
            var e = t * t + (n -= M) * n
              , f = (1 + c - e / (i * i)) / (2 * r)
              , v = u(f)
    ...
    function Tn(t, n) {
        return n > -Da ? (t = Ea(t, n),
        t[1] += La,
        t) : E(t, n)
    }
    function xn(t, n) {
        return Math.abs(n) > Da ? (t = Ea(t, n),
        t[1] -= n > 0 ? La : -La,
        t) : E(t, n)
    }
    function En(t, n) {
    ...
    function Fn(t) {
        ...
        return n.invert = function(n, e) {
            var o, i = e + t;
            return [Math.abs(e) < da ? n / a : Math.abs(o = pa / 4 + i / 2) < da || Math.abs(Math.abs(o) - wa) < da ? 0 : n * Math.log(Math.tan(o) / r) / e, i]
        }
        ,
        n
    }
    function jn(t, n) {
        return [t, 1.25 * Math.log(Math.tan(pa / 4 + .4 * n))]
    }
    function An(t) {
        function n(n, r) {
            for (var e, o = Math.cos(r), i = 2 / (1 + o * Math.cos(n)), h = i * o * Math.sin(n), u = i * Math.sin(r), M = a, s = t[M], c = s[0], f = s[1]; --M >= 0; )
                s = t[M],
                c = s[0] + h * (e = c) - u * f,
                f = s[1] + h * f + u * e;
            return c = h * (e = c) - u * f,
        ...
        return n.invert = function(n, r) {
            var e = 20
              ...
              , i = r;
            do {
                for (var u, M = a, s = t[M], c = s[0], f = s[1], v = 0, l = 0; --M >= 0; )
                    s = t[M],
                    v = c + o * (u = v) - i * l,
                    l = f + o * l + i * u,
                    c = s[0] + o * (u = c) - i * f,
                ...
                o -= g = (c * v + f * l) / b,
                i -= d = (f * v - c * l) / b
            } while (Math.abs(g) + Math.abs(d) > da * da && --e > 0);if (e) {
    ...
    function Gn() {
        ...
        return a.coefficients = function(a) {
            return arguments.length ? n(t = "string" == typeof a ? Oa[a] : a) : t
        }
        ,
        a
    }
    ...
    function Dn(t, n) {
        for (var a, r = (1 + Math.SQRT1_2) * Math.sin(n), e = n, o = 0; 25 > o && (e -= a = (Math.sin(e / 2) + Math.sin(e) - r) / (.5 * Math.cos(e / 2) + Math.cos(e)),
        !(Math.abs(a) < da)); o++)
            ;
        return [t * (1 + 2 * Math.cos(e) / Math.cos(e / 2)) / (3 * Math.SQRT2), 2 * Math.sqrt(3) * Math.sin(e / 2) / Math.sqrt(2 + Math.SQRT2)]
    }
    function Ln(t, n) {
        for (var a, r = Math.sqrt(6 / (4 + pa)), e = (1 + pa / 4) * Math.sin(n), o = n / 2, i = 0; 25 > i && (o -= a = (o / 2 + Math.sin(o) - e) / (.5 + Math.cos(o)),
        !(Math.abs(a) < da)); i++)
            ;
    ...
    function Kn(t) {
        ...
        return n.invert = function(n, r) {
            ...
            } while (Math.abs(e) > da && --M > 0);var v = n * (s = Math.tan(i))
    ...
    function Nn(t, n) {
        var a, r = Math.min(18, 36 * Math.abs(n) / pa), e = Math.floor(r), o = r - e, i = (a = Za[e])[0], h = a[1], u = (a = Za[++e])[0], M = a[1], s = (a = Za[Math.min(19, ++e)])[0], c = a[1];
    ...
    function Wn() {
        ...
        ,
        r.tilt = function(r) {
            return arguments.length ? a(t, n = r * pa / 180) : 180 * n / pa
        }
        ,
        r
    }
    ...
    function Yn(t) {
        function n(n, o) {
            ...
            return i *= i,
            h *= h,
            [(i - h) / (2 * t), s * M(4 * e * h - (e - i + h) * (e - i + h)) / (2 * t)]
        }
        if (!t)
            return d3.geo.azimuthalEquidistant.raw;
        var a = -t / 2
          , r = -a
          , e = t * t
          , o = Math.tan(r)
    ...
    var Ma = {
      ...
      , va = {
        ...
        lineEnd: function() {
            sa.length && (ca.push(sa),
            sa = [])
        },
        result: function() {
            var t = ca.length ? ca.length < 2 ? {
                type: "LineString",
                coordinates: ca[0]
            } : {
                type: "MultiLineString",
      ...
      , la = {
        ...
        result: function() {
            ...
            var t = []
              , n = [];
            return ca.forEach(function(a) {
                r(a) ? t.push([a]) : n.push(a)
            }),
            n.forEach(function(n) {
                var a = n[0];
                t.some(function(t) {
                    return e(t[0], a) ? (t.push(n),
                    !0) : void 0
                }) || t.push([n])
            }),
            ca = [],
    ...
    d3.geo.interrupt = function(t) {
        function n(n, a) {
            for (var r = 0 > a ? -1 : 1, e = h[+(0 > a)], o = 0, i = e.length - 1; i > o && n > e[o][2][0]; ++o)
                ;
            var u = t(n - e[o][1][0], a);
            return u[0] += t(e[o][1][0], r * a > r * e[o][0][1] ? e[o][0][1] : a)[0],
            u
        }
        function a() {
            i = h.map(function(n) {
        ...
        var i, h = [[[[-pa, 0], [0, wa], [pa, 0]]], [[[-pa, 0], [0, -wa], [pa, 0]]]];
        ...
        u.lobes = function(t) {
            return arguments.length ? (h = t.map(function(t) {
                return t.map(function(t) {
                    return [[t[0][0] * pa / 180, t[0][1] * pa / 180], [t[1][0] * pa / 180, t[1][1] * pa / 180], [t[2][0] * pa / 180, t[2][1] * pa / 180]]
                })
            }),
            a(),
            u) : h.map(function(t) {
                return t.map(function(t) {
                    return [[180 * t[0][0] / pa, 180 * t[0][1] / pa], [180 * t[1][0] / pa, 180 * t[1][1] / pa], [180 * t[2][0] / pa, 180 * t[2][1] / pa]]
                })
            })
        }
        ,
    ...
    f.invert = function(t, n) {
        if (!(t * t + 4 * n * n > pa * pa + da)) {
            ...
            do {
                ...
                a -= R,
                r -= T
            } while ((Math.abs(R) > da || Math.abs(T) > da) && --e > 0);return [a, r]
        }
    }
    ,
    ...
    m.invert = function(t, n) {
        if ((r = Math.abs(n)) < Ra)
            return [t, 2 * Math.atan(Math.exp(n)) - wa];
        var a, r, e = Math.sqrt(8), o = pa / 4, h = 25;
        do {
            var u = Math.cos(o / 2)
              , M = Math.tan(o / 2);
            o -= a = (e * (o - pa / 4) - Math.log(M) - r) / (e - .5 * u * u / M)
        } while (Math.abs(a) > ba && --h > 0);return [t / (Math.cos(o) * (e - 1 / Math.sin(o))), i(n) * o]
    }
    ,
    ...
    T.invert = function(t, n) {
        var a, r, e = 2.00276, o = e * n, i = 0 > n ? -pa / 4 : pa / 4, h = 25;
        do
            r = o - Math.SQRT2 * Math.sin(i),
            i -= a = (Math.sin(2 * i) + 2 * i - pa * Math.sin(r)) / (2 * Math.cos(2 * i) + 2 + pa * Math.cos(r) * Math.SQRT2 * Math.cos(i));
        while (Math.abs(a) > da && --h > 0);return r = o - Math.SQRT2 * Math.sin(i),
    ...
    I.invert = function(t, n) {
        ...
        return [t * Math.sqrt(6 * pa) / (2 * a), i(n) * h((4 - a * a) / 3)]
    }
    ,
    ...
    J.invert = function(t, n) {
        ...
        return [t * a / (1 + M(1 - n * n * (4 + pa) / (4 * pa))), n * a / 2]
    }
    ,
    ...
    V.invert = function(t, n) {
        ...
        do {
            ...
            var C = (Q * F - S * A) / G
              , D = (S * j - Q * B) / G;
            r -= C,
            e = Math.max(-wa, Math.min(wa, e - D))
        } while ((Math.abs(C) > da || Math.abs(D) > da) && --o > 0);return Math.abs(Math.abs(e) - wa) < da ? [0, e] : o && [r, e]
    }
    ;
    ...
    d3.geo.gilbert = function(t) {
        function n(n) {
            return t([.5 * n[0], h(Math.tan(.5 * n[1] * ma)) * ya])
        }
        ...
        n.stream = function(n) {
            ...
            var r = a.stream({
                point: function(t, a) {
                    n.point(.5 * t, h(Math.tan(.5 * -a * ma)) * ya)
                },
                lineStart: function() {
                    n.lineStart()
                },
    ...
    an.invert = function(t, n) {
        ...
        } while (Math.abs(a) > da && --o > 0);o = 50,
        t /= 1 - .162388 * i;
        do {
            var h = (h = r * r) * h;
            r -= a = (r * (.87 - 952426e-9 * h) - t) / (.87 - .00476213 * h)
        } while (Math.abs(a) > da && --o > 0);return [r, e]
    }
    ,
    ...
    mn.invert = function(t, n) {
        var a = Math.abs(a = n * (0 > n ? .5179951515653813 : .5686373742600607)) > 1 - da ? a > 0 ? wa : -wa : h(a);
        return [1.1764705882352942 * t / Math.cos(a), Math.abs(a = ((a += a) + Math.sin(a)) * (0 > n ? .4102345310814193 : .3736990601468637)) > 1 - da ? a > 0 ? wa : -wa : h(a)]
    }
    ,
    ...
    (d3.geo.healpix = Sn).raw = yn,
    (d3.geo.hill = Rn).raw = Qn;
    ...
    xn.invert = function(t, n) {
        return Math.abs(n) > Da ? Ea.invert(t, n + (n > 0 ? La : -La)) : E.invert(t, n)
    }
    ,
    ...
    zn.invert = function(t, n) {
        ...
        do {
            ...
            a -= d,
            r -= b
        } while ((Math.abs(d) > da || Math.abs(b) > da) && --e > 0);return e && [a, r]
    }
    ,
    ...
    jn.invert = function(t, n) {
        return [t, 2.5 * Math.atan(Math.exp(.8 * n)) - .625 * pa]
    }
    ,
    ...
    Ln.invert = function(t, n) {
        var a = Math.sqrt(6 / (4 + pa))
          , r = n / a;
        return Math.abs(Math.abs(r) - wa) < da && (r = 0 > r ? -wa : wa),
        [1.5 * t / (a * (.5 + Math.cos(r))), h((r / 2 + Math.sin(r)) / (1 + pa / 4))]
    }
    ,
    ...
    On.invert = function(t, n) {
        ...
        } while (Math.abs(a) > da && --e > 0);return [t / (.8707 + (o = r * r) * (-.131979 + o * (-.013791 + o * o * o * (.003971 - .001529 * o)))), r]
    }
    ,
    ...
    In.invert = function(t, n) {
        ...
        } while (Math.abs(a) > da);return [t, r]
    }
    ,
    ...
    (d3.geo.peirceQuincuncial = function() {
        return Ya().quincuncial(!0).rotate([-90, -90, 45]).clipAngle(180 - 1e-6)
    }
    ).raw = Ya.raw,
    Jn.invert = function(t, n) {
        if (Math.abs(n) < da)
        ...
        } while (Math.abs(a) > da && --o > 0);return M = Math.tan(e),
        [(Math.abs(n) < Math.abs(e + 1 / M) ? h(t * M) : i(t) * (u(Math.abs(t * M)) + wa)) / Math.sin(e), e]
    }
    ,
    ...
    var Za = [[.9986, -.062], [1, 0], [.9986, .062], [.9954, .124], [.99, .186], [.9822, .248], [.973, .31], [.96, .372], [.9427, .434], [.9216, .4958], [.8962, .5571], [.8679, .6176], [.835, .6769], [.7986, .7346], [.7597, .7903], [.7186, .8435], [.6732, .8936], [.6213, .9394], [.5722, .9761], [.5322, 1]];
        ...
        do {
            ...
            if (v >= 0 || 1 === o) {
                ...
                do
                    ...
                    h = Za[o + 1][1],
                    u = Za[Math.min(19, o + 2)][1],
                    r -= (l = (n >= 0 ? wa : -wa) * (h + v * (u - i) / 2 + v * v * (u - 2 * h + i) / 2) - n) * ya;
                while (Math.abs(l) > ba && --g > 0);break
            }
        } while (--o >= 0);var d = Za[o][0]
          , b = Za[o + 1][0]
    ...
    ea.invert = function(t, n) {
        ...
        do {
            ...
            o -= δ = w / q
        } while (δ > da && --h > 0);return [i(t) * (Math.sqrt(r * r + 4) + r) * pa / 4, wa * o]
    }
    ,
    ...
    ua.invert = function(t, n) {
        var a = t
          ...
          , e = 25;
        do {
            var o, i = Math.cos(r), h = Math.sin(r), M = Math.sin(2 * r), s = h * h, c = i * i, f = Math.sin(a), v = Math.cos(a / 2), l = Math.sin(a / 2), g = l * l, d = 1 - c * v * v, b = d ? u(i * v) * Math.sqrt(o = 1 / d) : o = 0, p = .5 * (2 * b * i * l + a / wa) - t, w = .5 * (b * h + r) - n, q = .5 * o * (c * g + b * i * v * s) + .5 / wa, m = o * (f * M / 4 - b * h * l), y = .125 * o * (M * l - b * h * c * f), S = .5 * o * (s * v + b * g * i) + .5, Q = m * y - S * q, R = (w * m - p * S) / Q, T = (p * y - w * q) / Q;
            a -= R,
            r -= T
        } while ((Math.abs(R) > da || Math.abs(T) > da) && --e > 0);return [a, r]
    }
...
!function(n, t) {
    ...
    function r(n) {
        if (!n)
            return t;
        var r, e, o = n.scale[0], i = n.scale[1], u = n.translate[0], f = n.translate[1];
        return function(n, t) {
            t || (r = e = 0),
            n[0] = (r += n[0]) * o + u,
            n[1] = (e += n[1]) * i + f
    ...
    function e(n) {
        ...
        return function(n, t) {
            t || (r = e = 0);
            var c = Math.round((n[0] - u) / o)
              , a = Math.round((n[1] - f) / i);
            n[0] = c - r,
            n[1] = a - e,
            r = c,
            e = a
    ...
    function f(n, t) {
        ...
        return null == t.id && delete r.id,
        r
    }
    function c(n, t) {
        function e(n, t) {
            t.length && t.pop();
            for (var r, e = l[0 > n ? ~n : n], i = 0, u = e.length; u > i; ++i)
                t.push(r = e[i].slice()),
                s(r, i);
            0 > n && o(t, u)
        }
        ...
        function u(n) {
            for (var t = [], r = 0, o = n.length; o > r; ++r)
                e(n[r], t);
            return t.length < 2 && t.push(t[0].slice()),
            t
        }
        function f(n) {
    ...
    function l(n, t, r) {
        ...
        function u(n) {
            "GeometryCollection" === n.type ? n.geometries.forEach(u) : n.type in l && (c = n,
            l[n.type](n.arcs))
        }
        var f = [];
        if (arguments.length > 1) {
            ...
            u(t),
            s.forEach(arguments.length < 3 ? function(n) {
                f.push(n[0].i)
            }
            : function(n) {
            ...
            for (var h = 0, p = n.arcs.length; p > h; ++h)
                f.push(h);
        return {
            type: "MultiLineString",
            arcs: a(n, f)
        ...
        function r(n) {
            n.forEach(function(t) {
                t.forEach(function(t) {
                    (o[t = 0 > t ? ~t : t] || (o[t] = [])).push(n)
                })
            }),
            i.push(n)
        }
        function e(t) {
            return Math.abs(p(c(n, {
                type: "Polygon",
                arcs: [t]
            }).coordinates[0]))
        }
        ...
        }),
        {
            ...
            arcs: u.map(function(t) {
                ...
                if (t.forEach(function(n) {
                    n.forEach(function(n) {
                        n.forEach(function(n) {
                            o[0 > n ? ~n : n].length < 2 && i.push(n)
                        })
                    })
                }),
                i = a(n, i),
                (r = i.length) > 1)
                    for (var u, f, c = 1, s = e(i[0]); r > c; ++c)
                        (u = e(i[c])) > s && (f = i[0],
                        i[0] = i[c],
                        i[c] = f,
                        s = u);
    ...
    function y(n) {
        ...
        n.forEach(e);
        for (var c in o)
            for (var a = o[c], s = a.length, l = 0; s > l; ++l)
                for (var h = l + 1; s > h; ++h) {
                    var p, v = a[l], g = a[h];
        ...
        function t(n, t) {
            for (; ; ) {
                var r = t + 1 << 1
                  ...
                  , u = t
                  , f = e[u];
                if (o > i && d(e[i], f) < 0 && (f = e[u = i]),
                o > r && d(e[r], f) < 0 && (f = e[u = r]),
                u === t)
                    break;
                e[f._ = t] = f,
                e[n._ = t = u] = n
