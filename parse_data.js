...
function parse_json(input_historic, input_price) {
    var player_historic_filtered = { data: [] };
    
    _.each(input_historic.players, function(e, i) { 
        if(e != null) { player_historic_filtered.data.push({date: moment((input_historic.start + input_historic.step * i) * 1000).format("DD-MM-YY"), players: e}); }
